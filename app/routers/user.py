...
def edit(user: schemas.UserEdit, current_user: models.User = Depends(oauth2.get_current_user),
...
@router.patch("/change-password/{user_id}", status_code=status.HTTP_200_OK, response_model=schemas.UserChangePassword)
