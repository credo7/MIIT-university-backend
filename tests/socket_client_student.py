...
# teacher_token = login(username="vtniigfirst", password="password")
...
fake_events = [
    {'id': 1, 'type': 2, 'mode': 'CLASS'},
]


socket_url = 'http://localhost:3002'
student_sio = CustomSocketIO(
    socket_url=socket_url, headers=custom_headers(token=student_token, computer_id=1), computer_id=1,
)
