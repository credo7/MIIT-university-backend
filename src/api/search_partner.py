...
async def search_partner(
        search_partner_dto: SearchPartner,
...
async def invite_someone(
        invite_partner_dto: InvitePartner
):
...
async def accept_invite(
        accept_invite_dto: AcceptInvite
):
...
async def cancel_invite(
        reject_invite_dto: RejectInvite
):
    response = {
