...
Определить ĸонтраĸтную стоимость.""",
    'test_questions': [
        ...
        },
        {
            ...
            'options': [
                {'id': 0, 'value': 'Обязанности продавца и покупателя, риск перехода ответственности, какая из сторон отвечает за расходы', 'is_correct': True,},
        ...
        },
        {
            ...
            'options': [{'id': 0, 'value': 'Не является обязательным документом', 'is_correct': True}, {'id': 1, 'value': 'Является обязательным документом'},],
        },
        {
            'id': 5,
        ...
        {'id': 6, 'question': '«Свободно с завода»', 'options': [{'id': 0, 'value': 'EXW', 'is_correct': True}, {'id': 1, 'value': 'FCA'}, {'id': 2, 'value': 'FOB'}, {'id': 3, 'value': 'FAS'},],},
        {'id': 7, 'question': '«Франко перевозчик»', 'options': [{'id': 0, 'value': 'FSA', 'is_correct': True}, {'id': 1, 'value': 'EXW'}, {'id': 2, 'value': 'FOB'}, {'id': 3, 'value': 'FAS'},],},
        {'id': 8, 'question': '«Свободно на борту»', 'options': [{'id': 0, 'value': 'FOB', 'is_correct': True}, {'id': 1, 'value': 'EXW'}, {'id': 2, 'value': 'FCA'}, {'id': 3, 'value': 'FAS'},],},
        {
            'id': 9,
            'question': '«Свободно вдоль борта судна»',
            'options': [{'id': 0, 'value': 'FAS', 'is_correct': True}, {'id': 1, 'value': 'EXW'}, {'id': 2, 'value': 'FCA'}, {'id': 3, 'value': 'FOB'},],
        },
        {'id': 10, 'question': '«Стоимость и фрахт»', 'options': [{'id': 0, 'value': 'CFR', 'is_correct': True}, {'id': 1, 'value': 'FOB'}, {'id': 2, 'value': 'DAP'}, {'id': 3, 'value': 'DDP'},],},
        {
            'id': 11,
        ...
        {'id': 15, 'question': '«Поставка в пункте»', 'options': [{'id': 0, 'value': 'DAP', 'is_correct': True}, {'id': 1, 'value': 'CIF'}, {'id': 2, 'value': 'DDP'}, {'id': 3, 'value': 'DPU'},],},
        {
            'id': 16,
