...
В расчете учитывать Цену производителя = Цена производителя * размер партии
...
Продукция отгружается со склада продавца, упакована на поддонах. Стоимость упаковки включена в стоимость товара. (Означает Цену производителя + Упаковку + Проверку товара)
...
Доставку до порта Калининград обеспечивает международный логистический провайдер за {4} у.е. с учетом доставки в порт Гамбург автомобильным транспортом, погрузки на судно, доставки в порт Калининград и выгрузки на терминале (Означает Расходы на погрузку + Доставку товара перевозчику)
...
по {1} у.е. за телевизор.

Товар отгружается со склада производителя в транспортной упаковке на поддонах.(Означает Цену производителя + Упаковку + Проверку товара)

Доставку до границы обеспечивает международный перевозчик 
по стоимости {2} у.е.  (Означает Доставку товара перевозчиком)
