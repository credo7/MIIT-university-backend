...
Сделка заключена на условиях поставки {6}""",
    ...
    'test_questions': [
        ...
        {
            'id': 17,
            'question': 'Какое обязательство группа «E» Инкотермс накладывает на продавца?',
            'options': [
        ...
        {
            'id': 18,
            'question': 'Какое обязательство группа «F» Инкотермс накладывает на продавца?',
            'options': [
        ...
        {
            'id': 20,
            'question': 'Какое обязательство группа «D» Инкотермс накладывает на продавца? ',
            'options': [
        ...
        {
            'id': 23,
            'question': 'Какие термины обязывают застраховать товар от всех рисков? ',
            'options': [
        ...
        {
            'id': 27,
            'question': 'При каком условии покупатель обязан выполнить экспортное и импортное таможенное оформление, а также доставить товар?',
            'options': [
                {'id': 0, 'value': 'EXW', 'is_correct': True},
                {'id': 1, 'value': 'FOB'},
                {'id': 2, 'value': 'DAP'},
        ...
        {
            'id': 28,
            'question': 'При каком условии риски переходят в момент передачи товара\nна складе продавца?',
            'options': [
                {'id': 0, 'value': 'EXW', 'is_correct': True},
                {'id': 1, 'value': 'FOB'},
                {'id': 2, 'value': 'DAP'},
        ...
        {
            'id': 29,
            'question': 'При каком условии продавец обязан выполнить экспортное таможенное оформление, доставить товар в порту отгрузки и погрузить на борт судна, указанного покупателем?',
            'options': [
                {'id': 0, 'value': 'FCA', 'is_correct': True},
                {'id': 1, 'value': 'EXW'},
                {'id': 2, 'value': 'DDP'},
        ...
        {
            'id': 30,
            'question': 'При каком условии покупатель обязан принять прибывший в порт разгрузки товар, а также выполнить импортное таможенное оформление?',
            'options': [
                {'id': 0, 'value': 'CFR', 'is_correct': True},
                {'id': 1, 'value': 'FAS'},
                {'id': 2, 'value': 'CPT'},
        ...
        {
            'id': 33,
            'question': 'При каком условии покупатель обязан принять товар в порту разгрузки, разгрузить, а также выполнить импортное таможенное оформление?',
            'options': [
                {'id': 0, 'value': 'CIF', 'is_correct': True},
                {'id': 1, 'value': 'EXW'},
                {'id': 2, 'value': 'DDP'},
        ...
        {
            'id': 34,
            'question': 'При каком условии поставки риски переходят в порту\nв момент размещения товара вдоль борта судна?',
            'options': [
                {'id': 0, 'value': 'FAS', 'is_correct': True},
                {'id': 1, 'value': 'EXW'},
                {'id': 2, 'value': 'FOB'},
        ...
        {
            'id': 36,
            'question': 'При каком условии поставки покупатель обязан доставить товар в порт разгрузки, а также выполнить импортное таможенное оформление?',
            'options': [
                {'id': 0, 'value': 'FOB', 'is_correct': True},
                {'id': 1, 'value': 'EXW'},
                {'id': 2, 'value': 'DAP'},
        ...
        {
            'id': 38,
            'question': 'При каком условии поставки покупатель обязан разгрузить и принять товар в порту разгрузки,\nа также выполнить импортное таможенное оформление?',
            'options': [
                {'id': 0, 'value': 'CFR', 'is_correct': True},
                {'id': 1, 'value': 'FAS'},
                {'id': 2, 'value': 'CPT'},
        ...
        {
            'id': 41,
            'question': 'При каких условиях поставки риски переходят в порту отгрузки с момента полной погрузки на борт судна?',
            'options': [
                {'id': 0, 'value': 'FOB', 'is_correct': True},
                {'id': 1, 'value': 'CFR'},
                {'id': 2, 'value': 'CIF'},
        ...
        {
            'id': 49,
            'question': 'При каких условиях поставки покупатель обязан принять товар и выполнить импортное таможенное оформление?',
            'options': [
        ...
        {
            'id': 50,
            'question': 'При каком условии риски переходят от продавца к покупателю в месте назначения после полной выгрузки?',
            'options': [
                {'id': 0, 'value': 'DPU', 'is_correct': True},
                {'id': 1, 'value': 'DAP'},
                {'id': 2, 'value': 'FOB'},
        ...
        {
            'id': 52,
            'question': 'При каком условии все риски несет покупатель?',
            'options': [
                {'id': 0, 'value': 'EXW', 'is_correct': True},
                {'id': 1, 'value': 'DPU'},
                {'id': 2, 'value': 'DAP'},
        ...
        {
            'id': 53,
            'question': 'При каком условии поставки риски переходят в месте назначения и все риски несет продавец?',
            'options': [
                {'id': 0, 'value': 'DDP', 'is_correct': True},
                {'id': 1, 'value': 'DPU'},
                {'id': 2, 'value': 'DAP'},
