...
и комплектуют в транспортный пакет на поддоне. 
...
Стоимость погрузĸи на борт судна в порту отправления (Погрузка 
на борт судна) - {6} у.е. 
...
Сделĸа заĸлючена на условиях поставĸи {6}""",
        ...
        в количестве {0} штук
по {1} у.е. за телевизор. Товар отгружается со склада производителя 
в транспортной упаковке на поддонах.(Означает Цена производителя + Упаковка + Проверка товара)
Доставку до границы обеспечивает международный перевозчик 
по стоимости {2} у.е.  (Означает Доставка товара перевозчику)
