...
с оборотом от 100 млн. до 1 млрд. рублей. Мы работам только по типу FCL — Full container load (товар в контейнере принадлежит одному получателю).
...
- работаем профессионально, оперативно и ответственно, поэтому 
нам доверяют не только частные, но и государственные заказчики, крупнейшие торговые и производственные компании;
...
Холдинг прочно закрепился в десятке лидеров операторского 
и вагоноремонтного бизнеса, а также входит в число лидеров рейтинга инвестиционной эффективности российских компаний.
...
в России многопрофильный терминал LUGAPORT грузооборотом 24,3 млн 
т. в год.

Стивидорная компания является генеральным агентом ФГУП «Росморпорт» на паромном комплексе в порту Усть-Луга, где оказывает стивидорные 
и складские услуги.    
...
В настоящее время мы предлагаем своим клиентам полный комплекс услуг по доставке грузов из Китая: транспортировка Short Sea 
до Владивостока или через сухие погран переходы от станций Эрлянь, Маньчжурия, Суйфэньхэ, Хоргос, Алашанькоу с доставкой грузов из Китая контейнерами по российским железным дорогам до Москвы, городов Сибири, а также сопроводительное таможенное оформление грузов 
из Китая.""",
        },
        {
            'letter': 'К',
...
Ценности компании – это, прежде всего, её клиенты, партнеры по бизнесу, 
а также персонал – три основополагающих «кита», на которых она строит свой успех. 
...
по провозной плате с ОАО «РЖД», установлена система «ЭТРАН» 
для удаленного (дистанционного) оформления перевозочных документов, кроме того имеется возможность производить все виды ремонтов вагонам на всей сети железных дорог. Компания может в режиме реального времени информировать клиентов-грузовладельцев 
и контрагентов-собственников вагонов о местонахождении вагона 
...
В рамках автомобилестроения организуем как доставку готовых автомобилей, так и логистическое обслуживание процесса производства — управление контейнерной доставкой широкой номенклатуры деталей 
для сборки по принципу «точно в срок» с учетом графика производства.
...
Это профессиональный долг, который толкает выйти за рамки формальностей, когда это необходимо для дела. Как по отношению к клиенту, так и по отношению 
к коллегам. 

Наши сотрудники — это больше, чем функция. Это соратники и единомышленники.
""",
        },
        {
            'letter': 'О',
...
Благодаря широкой сети международных партнеров и филиалов группы компании по всему миру, наша компания осуществляет транспортно-экспедиторские услуги, включая внутренние 
и международные грузоперевозки железнодорожным, воздушным 
и морским транспортом, а также организует полное таможенное сопровождение, страхование и ответственное хранение грузов 
в собственных логистических комплексах.
...
logists2 = [
    {
        ...
        'body': [
            ...
            {'type': 'text', 'texts': ['Маршруты Китай (Достык/Алтынколь) — Европа (Брест, Брузги, Свислочь, Калининград) по территориям Казахстана, России и Беларуси'],},
            {'type': 'dash', 'texts': ['Импорт']},
            {'type': 'text', 'texts': ['Перевозка грузов из КНР в Россию и Беларусь через погранпереходы Достык/Алтынколь'],},
            {'type': 'dash', 'texts': ['Экспорт']},
            {'type': 'text', 'texts': ['Перевозка грузов из России и Беларуси в КНР до погранпереходов Достык/Алтынколь', 'Комплекс транспортно-логистических услуг включает:',],},
            {
                'type': 'enumerated',
                'texts': [
