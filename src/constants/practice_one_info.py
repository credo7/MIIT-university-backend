from schemas import PracticeOneInfo
...
raw_practice_one_info = {
  "bets": [
    ...
    },
    {
      ...
      "incoterms": {
        "buyer": ["EXW", "FCA", "FAS"],
        "seller": ["FOB", "CFR", "CIF", "DPU", "DAP", "CPT", "CIP", "DDP"]
      }
    },
    {
      ...
      "incoterms": {
        ...
        "seller": ["CFR", "CIF", "DPU", "DAP", "CPT", "CIP", "DDP"]
      }
    },
    {
    ...
    },
    {
      ...
      "incoterms": {
        "buyer": ["EXW", "FCA", "FAS", "FOB", "CFR", "CIF", "CPT", "CIP"],
        "seller": ["DAP", "DPU", "DDP"]
      }
    },
    {
...
practice_one_info = PracticeOneInfo(**raw_practice_one_info)

# if __name__ == "__main__":
#   print(practice_one_info.bets)
